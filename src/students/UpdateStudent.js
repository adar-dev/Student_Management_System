...
export default function UpdateStudent() {
  ...
  const onSubmit=async(e)=>{
    ...
    // StudentDataService.update(stId,JSON.stringify(student)).then(response=> console.log(response.data)).catch((e)=> console.log(e))
  
    await fetch(`http://localhost:8081/api/students/${stId}` , {
      method: 'PUT',
      headers: { 
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-6 offset-md-3 brorder rounded p-4 mt-2 shadow">
          <h2 className="text-centre m-4">Update Student Record</h2>
